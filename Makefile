...
PACKAGE ?= helm-goldilocks
XRD_DIR := apis/goldilockses
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/goldilockses/standard.yaml
...
EXAMPLES := \
    examples/goldilockses/minimal.yaml:: \
    examples/goldilockses/standard.yaml::
...
render\:%:
	@example="examples/goldilockses/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
